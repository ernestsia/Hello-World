...
// Get all grades grouped by exam type
$grades_query = "SELECT 
                    e.exam_id,
                    e.exam_name,
                    e.exam_type,
...
<div class="row mb-4">
    <div class="col-12">
        <h2><i class="fas fa-chart-line"></i> Student Academic Progress</h2>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                                ...
                                <tr class="table-light">
                                    <td colspan="7">
                                        <small class="text-muted">
                                            <i class="fas fa-comment"></i> <strong>Teacher's Remarks:</strong> 
                            ...
                            <tfoot class="table-light">
                                <tr>
                                    <td colspan="4" class="text-end"><strong>Average for <?php echo $exam_type; ?>:</strong></td>
                                    <td colspan="3">
    ...
    <div class="col-12">
        <div class="card border-0 shadow-sm">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted">Your child's exam results will appear here once they are published by teachers.</p>
            </div>
        </div>
    </div>
</div>
